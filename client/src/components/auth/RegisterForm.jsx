...
const RegisterForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-3">
        <label htmlFor="name" className="form-label" style={{ fontSize: '14px', color: '#667781', fontWeight: '400' }}>Nama</label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="confirmPassword" className="form-label" style={{ fontSize: '14px', color: '#667781', fontWeight: '400' }}>Konfirmasi Password</label>
        <input
          type="password"
          className={`form-control ${validationError ? 'is-invalid' : ''}`}
          id="confirmPassword"
      ...
      <p className="text-center mb-0" style={{ color: '#667781', fontSize: '14px' }}>
        Sudah punya akun?{' '}
        <Link to="/login" className="text-decoration-none fw-semibold" style={{ color: '#075e54' }}>
          Login di sini
        </Link>
      </p>
    </form>
