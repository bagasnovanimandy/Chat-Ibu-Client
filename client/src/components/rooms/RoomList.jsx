  ...
  return (
    <div style={{ padding: "8px" }}>
      {loading ? (
        ...
        <div className="p-4 text-center small" style={{ color: "#667781" }}>
          No rooms available
        </div>
      ) : (
          ...
          {rooms.map((room) => (
            <div
              ...
              style={{
                cursor: "pointer",
                backgroundColor:
                  currentRoom?.id === room.id ? "#f0f2f5" : "white",
                borderRadius: "8px",
                padding: "12px",
                border:
              ...
              <div className="mb-2">
                ...
                {room.creator && (
                  <p
                    ...
                    style={{ color: "#667781", fontSize: "11px" }}
                  >
              ...
              >
                <div className="d-flex align-items-center justify-content-center gap-1">
                  <span
                    ...
                    style={{ color: "#128c7e", fontSize: "11px" }}
                  >
                    Klik untuk masuk
                  </span>
                  <ArrowRight
