  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ minHeight: 0, overflow: "hidden", backgroundColor: "#f0f2f5" }}
      >
        <div
          className="d-flex flex-column bg-white flex-shrink-0"
          style={{
            width: "280px",
            maxWidth: "280px",
        ...
        <div
          ...
          style={{ minHeight: 0, overflow: "hidden", minWidth: 0 }}
        >
          {currentRoom ? (
            <ChatWindow />
          ) : (
            ...
            >
              <div className="text-center">
                <MessageCircle
                  ...
                  style={{ color: "#667781", opacity: 0.4 }}
                />
